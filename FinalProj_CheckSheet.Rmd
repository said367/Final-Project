...
(A) .Rmd Line numbers where at least two different data sources are imported:  42,60


(B) .Rmd Line numbers for inspecting data intake:  50,51,52,68,69,70
...
(A) .Rmd Line number(s) for general data wrangling: 87,88,91,102,109,112


(B) .Rmd Line number(s) for a join operation: 80,94,95


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):


(D) .Rmd Line number(s) for use of regular expressions: 87


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 102
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 147
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 128

(B) .Rmd Line number(s) for use of multiple aesthetics:  121,128

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps:  

(E) .Rmd Line number(s) for use of decision tree or dendogram results:  137
